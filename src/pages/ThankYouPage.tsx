    ...
    <div className="bg-gray-200 min-h-screen flex justify-center">
      <div className="w-[50%] mt-[5%]">
        ...
        <div className="bg-white p-10 rounded-lg">
          ...
          <p>
            You can visit My Account page at any time to check the status of
            your order. Or click here to{" "}
            <a href="#" className="text-gray-700 underline font-medium">
              print a copy of your receipt
            </a>
          </p>

          <div className="mt-10">
            <Button label="Go back to shop" onClick={() => navigate("/")} />
          </div>
        </div>
      </div>
    </div>
