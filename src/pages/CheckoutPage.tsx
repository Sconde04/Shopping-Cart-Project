    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            <div className="container mx-auto p-8">
                <h1 className="flex justify-center text-3xl font-bold mb-14 mt-4">Checkout</h1>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-10">
                            ...
                            <Button
                                ...
                                onClick={() => { /* Tenemos que añadir el enlace a la poagina de thank you (PENDINENTE) */ }}
                                className="w-full font-semibold text-lg h-12"
                            />
                        </div>
                        <div className="text-center text-gray-500 text-sm mt-4 px-10">
                            <p>By clicking "Complete Purchase", Ic onfirm that I am aware and accept that I am obligued to pay for my order, I accept
                                the Terms and Conditions and confirm that I have read the Privacy Policy.
                            </p>
                        </div>
